...
const IssueCard = ({ issue }) => {
  return (
    <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 shadow-lg hover:border-blue-500 transition-colors">
      <div className="flex justify-between items-start mb-4">
        ...
        <span className={`px-3 py-1 rounded-full text-sm font-medium ${
          issue.status === 'Open' ? 'bg-green-900 text-green-300' : 'bg-yellow-900 text-yellow-300'
        }`}>
          {issue.status}
        </span>
      </div>
